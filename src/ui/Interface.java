...
public class Interface extends JFrame {
	...
	public Interface(String arg0) throws Exception {
		...
		// this.sequence = new JCheckBoxMenuItem("Sauvegarder les genomes
		// (sequence)");
		...
		// this.fine = new JCheckBoxMenuItem("Analyse fine (tous les
		// bioprojets)");
		...
		// this.jl_fin = new JLabel("Cochez pour une analyse fine (tous les
		// bioprojects)");
